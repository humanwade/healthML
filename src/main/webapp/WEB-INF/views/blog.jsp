    ...
    <div class="main-container w-container">
      <div class="nav-wrapper">
        ...
        <nav role="navigation" class="main-nav w-nav-menu">
          ...
          <a href="services.html" class="menu-item w-nav-link">services</a>
          <a href="blog.html" aria-current="page" class="menu-item w-nav-link w--current">blog</a>
...
<img loading="lazy" src="images/about.png" alt="" sizes="(max-width: 479px) 70vw, (max-width: 767px) 81vw, (max-width: 1919px) 39vw, 586.609375px" class="blog-main-image">
                  ...
                  <a href="#" class="link-to-single-post w-inline-block">
                    <h3 class="blog-title">hello 213133</h3>
                  </a>
                  <p class="blog-paragraph">lnlskd sdfinwafoi voin vaonvs ownsdfl</p>
                  <div class="blog-time">15151515</div>
                </div>
              </div>
            </div>
